    ...
    try {
      for (const informe of informes) {
        ...
        const response = await fetch(
          `https://resultados.mininterior.gob.ar/api/resultados/getResultados?anioEleccion=${
            informe.vAnio
          }&tipoRecuento=${informe.vTipoRecuento}&tipoEleccion=${
            informe.vTipoEleccion
          }&categoriaId=${informe.vCategoriaId}&distritoId=${
            informe.vDistrito
          }&seccionProvincialId=${informe.vSeccionProvincial}&seccionId=${
            informe.vSeccionID
          }&circuitoId=${""}&mesaId=${""}`
        );
        ...
        if (response.ok) {
          ...
          const mapa = mapas.find(
            (mapas) =>
              mapas.provincia.toLowerCase() == informe.provincia.toLowerCase()
          );

          const tdMapa = document.createElement("td");
          tdMapa.innerHTML = mapa.svg;
          tdMapa.classList.add("mapa");

          fila.appendChild(tdMapa);

          const tdEleccionTexto = document.createElement("td");
          tdEleccionTexto.style.width = "75px";

          fila.appendChild(tdEleccionTexto);

          let pTextoEleccionesChico = document.createElement("p");
          let pTextoPathChico = document.createElement("p");

          pTextoEleccionesChico.classList.add("texto-elecciones-chico");
          pTextoPathChico.classList.add("texto-path-chico");

          pTextoEleccionesChico.innerText = `Elecciones  ${informe.vAnio} | ${informe.tipoEleccion}`;
          pTextoPathChico.innerText = `${informe.vAnio} > ${informe.tipoEleccion} > Provisorio > ${informe.cargo} > ${informe.provincia}`;

          tdEleccionTexto.appendChild(pTextoEleccionesChico);
          tdEleccionTexto.appendChild(pTextoPathChico);

          const tdDatosGenerales = document.createElement("td");
          tdDatosGenerales.innerHTML = `<div class="main-cards">
  <div class="card">
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div>
      ...
      <p id="mesas-escrutadas">${data.estadoRecuento.mesasTotalizadas}</p>
    </div>
  </div>
  <div class="card">
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div>
      <p>Electores</p>
      <p id="electores">${data.estadoRecuento.cantidadElectores}</p>
    </div>
  </div>
  <div class="card">
     <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div>
      ...
      <p id="participacion">${data.estadoRecuento.participacionPorcentaje}%</p>
    </div>
  </div>
</div>`;
          fila.appendChild(tdDatosGenerales);

          const tdAgrupaciones = document.createElement("td");
          tdAgrupaciones.classList.add("agrupaciones");
          fila.appendChild(tdAgrupaciones);
          ...
          data.valoresTotalizadosPositivos.forEach((agrupacion) => {
            ...
            tdAgrupaciones.appendChild(agrupacionTexto);
    ...
    mensajeAmarillo.innerHTML = `<p><i class="fa-solid fa-exclamation"></i> No hay informes guardados para mostrar</p>`;
